...
while True:
    user = api.get_user('gjlunkad')
    api.update_profile(name=f'GUNJAN|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : GUNJAN|{follower_count(user)} Followers')
